...
Answer: The k-nearest (using k=3) neighbr for record #10 is record #6. The predicted risk is `good loss` with a probability of 67%.
...
Answer: The k-nearest (using k=1) neighbr for record #1 is record #2.  The predicted risk is `bad loss` with a probability of 100%.
...
Answer: The k-nearest (using k=1) neighbr for record #1 is record #90.  The predicted risk is `bad loss` with a probability of 100%.
